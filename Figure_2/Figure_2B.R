###############################################################################
# Code to visualize Figure Supplement 2B                                      #
#                                                                             #
...
# Load the data
Quantil_final_2 <- read.csv("/scicore/home/penny/masthi00/vaccine_resistance/Visalise/New_figure_clean/Data_Figure_2B.csv", header = T)
...
# Panel 3
P3 <- 
  ggplot(data = Quantil_final_2[Quantil_final_2$G == "eir", ]) +
  geom_line(aes(x = Range,
                y = M,
                color = G,
                linetype = Vaccine_type),
...
# Merge
PLOT_S1 <- plot_grid( P1, P2, P3, P4, P5, P6, ncol = 3, nrow = 2, scale = 1, label_size = 18 / constant, label_fontface = 2)
