...
# load the data
Prediction_table <- read.csv("/scicore/home/penny/masthi00/vaccine_resistance/Visalise/New_figure_clean/Data_Figure_3A.csv", header = T)
...
A.labs <- c("Children", "Adults", "Whole population")
names(A.labs) <- c("Children", "18", "0.75")
...
# Plot
PLOT_3 <- ggplot(data = Prediction_table_2) +
